 ...
 *
 * Implementing classes must provide methods for checking whether a value is within the SingleLinkedList.scope,
 * a method returning a random element within the SingleLinkedList.scope, and a method returning the size of the
 * SingleLinkedList.scope.
 *
...
public abstract class ScopedArrayGenerator<T> implements ArrayGenerator<T> {
    ...
    private Scope<T> scope; // the SingleLinkedList.scope of this generator
     ...
     * @return an array of the required size, containing values within this SingleLinkedList.scope
     */
    abstract T[] createArray(int size);

    /**
     * Generate an array of random values (within this generator's SingleLinkedList.scope).
     *
     * @param size the size of the array to be generated.
     * @return an array of the required size, containing random values from within the
     * permitted SingleLinkedList.scope.
     *
