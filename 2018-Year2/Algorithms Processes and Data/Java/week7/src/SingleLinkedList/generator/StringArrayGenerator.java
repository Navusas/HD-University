 ...
 * from strings in the alphabet defined by this generator's SingleLinkedList.scope.
 *
 * @author Hugh Osborne
...
public class StringArrayGenerator extends ScopedArrayGenerator<String> {
     ...
     *
     * @param scope the SingleLinkedList.scope of the Strings permitted for this generator.
     */
