 ...
 * from characters in the alphabet defined by this generator's SingleLinkedList.scope.
 *
 * @author Hugh Osborne
...
public class CharacterArrayGenerator extends ScopedArrayGenerator<Character>
{
  /**
     ...
     *
     * @param scope the SingleLinkedList.scope of the characters permitted for this generator.
     */
