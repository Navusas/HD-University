...
/**
 * An implementation of an {@link SingleLinkedList.scope.AlphabetScope} for characters.
 *
 * @author Hugh Osborne
...
public class CharacterScope extends AlphabetScope<Character> {
    ...
    /**
     * If no SingleLinkedList.scope is specified, use the default alphabet.
     */
    ...
    /**
     * Specify the SingleLinkedList.scope by means of a String.
     *
     * @param alphabet the alphabet to be used for this SingleLinkedList.scope.
     */
    ...
    /**
     * Specify the SingleLinkedList.scope by means of a set of values.
     *
     * @param alphabet the set of permitted values for this SingleLinkedList.scope.
     */
