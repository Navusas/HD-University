package SingleLinkedList.linkedList;

import SingleLinkedList.linkedList.node.SingleLinkNode;
...
public class SingleLinkList<T>
    ...
    public void add(int index, T value) throws ListAccessError {
        ...
        if (isEmpty()) {
            ...
            while (nextLink != null) {
                // change root element, when trying to store value at position 0
                if ((nextLink == getRoot()) && (currentNodeIndex == index)) {
                    // create new node holding reference to root
                ...
                // For anything else. Once the node is found, add references to previous and new nodes
                    ...
                    // create a new node having a reference to next node
                    SingleLinkNode<T> newNode = new SingleLinkNode<T>(value, nextLink.getNext());
