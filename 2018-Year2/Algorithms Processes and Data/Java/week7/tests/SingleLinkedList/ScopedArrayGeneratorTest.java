...
/**
 * Implements additional tests, above those defined in {@link SingleLinkedList.ArrayGeneratorTest}, to
 * check that:
 * <ul>
 *     <li> Values in generated arrays are within the specified SingleLinkedList.scope</li>
 *     <li> All values in the SingleLinkedList.scope are generated.  Note: this is a statistical test, and may produce a
 *          false fail.  See {@link #testCoversRange(Scope)} for details.</li>
 * </ul>
 */
 public abstract class ScopedArrayGeneratorTest<T> extends ArrayGeneratorTest<T> {

    public abstract ScopedArrayGenerator<T> getGenerator(Scope<T> scope);

    /**
     * Check that the array contents are within the specified range.
     * @param scope the SingleLinkedList.scope to be tested
     * @param size the size of the array
     */
    public void testWithinRange(Scope<T> scope, int size) {
    ...
    /**
     * When testing that a generated array contains all the values within the generator's SingleLinkedList.scope,
     ...
     *    n    is the number of values within the SingleLinkedList.scope of this generator, and
