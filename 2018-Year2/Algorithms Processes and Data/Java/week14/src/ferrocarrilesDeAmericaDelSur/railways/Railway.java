...
public abstract class Railway extends Thread {
    ...
    private int id; // the id of railway
    ...
    private static Priority turn = new Priority();
    ...
    public Railway(int id, String name, Delay delay) {
        this.name = name;
        this.id = id;
        this.delay = delay;
    ...
    public static enum Position {
        ...
        public String toString() {
            switch (this) {
                case START_PASS:
                    return "at the start of the pass";
                case IN_PASS:
                    return "in the pass";
                case END_PASS:
                    return "at the end of the pass";
                default:
                    return "at an undefined position on the railway (ERROR)";
            }
        }
    }
    ...
    /**
     * Get current railway id specified at creation
     *
     * @return the id of the railway
     */
    ...
    /**
     * Checks who's turn is next to pass Critical Section
     *
     * @return true if it is the railways turn
     */
    public boolean isMyTurn() {
        return turn.checkTurn(this.id);
    }

    /**
     * Changes turn to the next railways id
     */
    public void changeTurn() {
        turn.setTurn((this.id + 1) % 2);
    }

    /**
     * Gets in
     *
     * @return true if it is other railway priority
     */
    public boolean priorityOverOther() {
        return turn.checkTurn((this.id + 1) % 2);
    }
}
