...
public class GUIWindow {
    ...
    private JButton exitGameplaysBT;
    ...
    private GUIWindow() {
        ...
        startGameBT.addActionListener(e -> {
            ...
            if (!usernameTF.getText().equals("")) {
                start();
                usernameTF.setText("");
                exitGameplaysBT.setVisible(true);
            } else {
        ...
        exitGameplaysBT.addActionListener(e -> {
            client.exitWholeGameplay();
            exitGameplaysBT.setVisible(false);
        } );
    }
    /*
